...
class ContentAsset:
    content_id:str; media_type:str; source_uri:str; published_at:datetime|None=None; duration_seconds:float|None=None; metadata:dict[str,Any]|None=None
...
class DeterministicMediaAnalyzer:
    def analyze(self,asset:ContentAsset)->tuple[ModalityObservation,...]:
        return (ModalityObservation("text",{"hook":{"strength":0.0},"narrative":{},"emotion":{},"audience_signals":{},"brand_signals":{}},source_ref=asset.source_uri,confidence=0.0),)
class MediaPipeline:
    ...
    def process(self,asset:ContentAsset)->ContentGenome:
        return build_content_genome(content_id=asset.content_id,observations=list(self._analyzer.analyze(asset)))
