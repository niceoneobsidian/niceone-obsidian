...
FOOTBALL_AGENTS: tuple[FootballAgentSpec, ...] = (
    ...
    FootballAgentSpec("football.player_agent", "Player and lineup intelligence", ("football.player_state", "football.player_stats")),
    ...
    FootballAgentSpec("football.live_agent", "Live match intelligence", ("football.live_update", "football.live_feed")),
