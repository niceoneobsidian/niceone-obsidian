...
color_foreground="0c/00/6b"
color_background="f2/f1/f8"

if [ -n "$ITERM_SESSION_ID" ]; then
  # iTerm2 proprietary escape codes
  put_template_custom Pg "0c006b"
  put_template_custom Ph "f2f1f8"
  put_template_custom Pi "0c006b"
  put_template_custom Pj "d5d3e5"
  put_template_custom Pk "0c006b"
  put_template_custom Pl "0c006b"
  put_template_custom Pm "f2f1f8"
else
